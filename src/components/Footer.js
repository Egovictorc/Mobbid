  ...
  return (
    <footer className="footer">
      ...
      {/* <div className="footer__mail">  */}
        <a href="mailto:egovictorc@gmail.com, anelechichiebuka@gmail.com"  title="message us" className="footer__mail-container">
          <Mail titleAccess="Message us" className="footer__mail" fontSize="inherit" />
        </a>
      {/* </div> */}
        ...
        <ul className="footer__list">
          {socialLinks.map(link => (
            <li className="footer__item" key={link.alt}>
              <a href={link.to} className="footer__link footer__link--social" title={link.title} rel="noreferrer">
                <img
                  src={link.src}
                  alt={link.alt}
      ...
      <div className="footer__div footer__div--link">
        ...
        <p className="footer__par">{new Date().getFullYear()} Mobbid technologies</p>
      </div>
    </footer>
  );
};
